...
import com.codeforiraq.drug.callbacks.OnLikeCommentListener;
...
public class popup8 extends AppCompatActivity implements OnLikeCommentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cc = -1;
        mDatabase = FirebaseDatabase.getInstance().getReference().child("commentes8");
        mDatabaselike = FirebaseDatabase.getInstance().getReference().child("likes8"); // hon ghalat ok aha ana lm astamlah asasn ok
        ...
        key2 = mDatabaselike.child("likes8").push().getKey();
        comment = new Comment();
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnLikeCommentListener(popup8.this);
    ...
    public void sen(View view) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("commentes8");
        ...
        if (mauth.getCurrentUser() != null) {
            ...
            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    key = mDatabase.child("commentes8").push().getKey();
                    ...
                    Toast.makeText(popup8.this, " your comment will appear when admin approve.",
...
//dash itm=new dash();
                        ...
                        if (mauth2.getCurrentUser() != null) {
                            ...
                            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    count++;
                                    Comment mm = new Comment(desc, mn[0], "1", time, count);
    ...
    @Override
    public void onLikeComment(final Comment comment, int position) {
        ...
        if (mauth2.getCurrentUser() != null) {
            ...
            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    childrens.put("like8", comment.like++);
