...
public class popup10 extends AppCompatActivity implements OnLikeCommentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cc = -1;
        mDatabase = FirebaseDatabase.getInstance().getReference().child("commentes10");
        mDatabaselike = FirebaseDatabase.getInstance().getReference().child("likes10"); // hon ghalat ok aha ana lm astamlah asasn ok
        ...
        key2 = mDatabaselike.child("likes10").push().getKey();
        comment = new Comment();
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnLikeCommentListener(popup10.this);
    ...
    public void sen(View view) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("commentes10");
        ...
        if (mauth.getCurrentUser() != null) {
            ...
            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    key = mDatabase.child("commentes10").push().getKey();
                    ...
                    Toast.makeText(popup10.this, " your comment will appear when admin approve.",
...
// hooon tamam !! ?yes ok;):d
        ...
        childrens.put("like10", comment.like++);
