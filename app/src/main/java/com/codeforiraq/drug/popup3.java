...
public class popup3 extends AppCompatActivity implements OnLikeCommentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cc = -1;
        mDatabase = FirebaseDatabase.getInstance().getReference().child("commentes3");
        mDatabaselike = FirebaseDatabase.getInstance().getReference().child("likes3"); // hon ghalat ok aha ana lm astamlah asasn ok
        ...
        key2 = mDatabaselike.child("likes3").push().getKey();
        comment = new Comment();
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnLikeCommentListener(popup3.this);
    ...
    public void sen(View view) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("commentes3");
        ...
        if (mauth.getCurrentUser() != null) {
            ...
            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    key = mDatabase.child("commentes3").push().getKey();
                    ...
                    Toast.makeText(popup3.this, " your comment will appear when admin approve.",
...
// hooon tamam !! ?yes ok;):d
        ...
        childrens.put("like2", comment.like++);
