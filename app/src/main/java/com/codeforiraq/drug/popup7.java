...
public class popup7 extends AppCompatActivity implements OnLikeCommentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cc = -1;
        mDatabase = FirebaseDatabase.getInstance().getReference().child("commentes7");
        mDatabaselike = FirebaseDatabase.getInstance().getReference().child("likes7"); // hon ghalat ok aha ana lm astamlah asasn ok
        ...
        key2 = mDatabaselike.child("likes7").push().getKey();
        comment = new Comment();
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnLikeCommentListener(popup7.this);
    ...
    public void sen(View view) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("commentes7");
        ...
        if (mauth.getCurrentUser() != null) {
            ...
            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    key = mDatabase.child("commentes7").push().getKey();
                    ...
                    Toast.makeText(popup7.this, " your comment will appear when admin approve.",
