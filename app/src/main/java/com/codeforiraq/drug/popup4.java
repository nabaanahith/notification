...
public class popup4 extends AppCompatActivity implements OnLikeCommentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cc = -1;
        mDatabase = FirebaseDatabase.getInstance().getReference().child("commentes4");
        mDatabaselike = FirebaseDatabase.getInstance().getReference().child("likes4"); // hon ghalat ok aha ana lm astamlah asasn ok
        ...
        key2 = mDatabaselike.child("likes4").push().getKey();
        comment = new Comment();
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnLikeCommentListener(popup4.this);
    ...
    public void sen(View view) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("commentes4");
        ...
        if (mauth.getCurrentUser() != null) {
            ...
            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    key = mDatabase.child("commentes4").push().getKey();
                    ...
                    Toast.makeText(popup4.this, " your comment will appear when admin approve.",
...
// hooon tamam !! ?yes ok;):d
        ...
        childrens.put("like4", comment.like++);
