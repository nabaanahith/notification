...
public class popup2 extends AppCompatActivity implements OnLikeCommentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cc = -1;
        mDatabase = FirebaseDatabase.getInstance().getReference().child("commentes2");
        mDatabaselike = FirebaseDatabase.getInstance().getReference().child("likes2"); // hon ghalat ok aha ana lm astamlah asasn ok
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnLikeCommentListener(popup2.this);
    ...
    public void sen(View view) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("commentes2");
        ...
        if (mauth.getCurrentUser() != null) {
            ...
            mDatabase2.child(uid + "/name").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    key = mDatabase.child("commentes2").push().getKey();
                    ...
                    Toast.makeText(popup2.this, " your comment will appear when admin approve.",
