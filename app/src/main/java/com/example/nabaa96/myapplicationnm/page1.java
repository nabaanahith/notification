...
//
        ...
        bp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (firebaseUser == null) {
                    ...
                    Intent ii = new Intent(getBaseContext(), popup.class);
                    ii.putExtra("n", u[0]);
                    startActivity(ii);
                }
            }
    ...
    private void showdi( int activity) {

        AlertDialog.Builder di = new AlertDialog.Builder(page1.this);
    ...
    private void hideItem(int item) {
        NavigationView navigationView;
        navigationView = (NavigationView) findViewById(R.id.nav_view);
        Menu nav_Menu = navigationView.getMenu();
